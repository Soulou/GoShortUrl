...
func main() {
	...
	rev.RegisterController((*controllers.UrlController)(nil),
		[]*rev.MethodType{
			&rev.MethodType{
				Name: "Save",
				Args: []*rev.MethodArg{ 
					&rev.MethodArg{Name: "url", Type: reflect.TypeOf((*string)(nil)) },
				},
			...
			&rev.MethodType{
				Name: "Show",
				Args: []*rev.MethodArg{ 
					&rev.MethodArg{Name: "digest", Type: reflect.TypeOf((*string)(nil)) },
				},
				RenderArgNames: map[int][]string{ 
				},
			},
